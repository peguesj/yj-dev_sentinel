...
class SpecializedAdapterMixin:
    """Mixin class to provide safe agent method calling."""
...
class VCMAAdapter(MCPAgentAdapter, SpecializedAdapterMixin):
...
class VCLAAdapter(MCPAgentAdapter, SpecializedAdapterMixin):
...
class CDIAAdapter(MCPAgentAdapter, SpecializedAdapterMixin):
...
class RDIAAdapter(MCPAgentAdapter, SpecializedAdapterMixin):
...
class SAAAdapter(MCPAgentAdapter, SpecializedAdapterMixin):
